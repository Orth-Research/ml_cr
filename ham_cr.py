...
def ham_cr_PG_C4v_J_4(x0, x1,x2, x3, x4):
	J = 4
	dim=2*J+1
	ham = np.arange(dim*dim, dtype=np.float)
	ham = ham.reshape(dim,dim)
	ham[0][0] = 0.8090398349558905*x0 + 4.786344211304794*x0*x1 + 2.8160379844863472*x0*x3 - 0.8090398349558905*x0*np.abs(x1) - 0.8090398349558905*x0*np.abs(x2) - 0.8090398349558905*x0*np.abs(x3) - 0.8090398349558905*x0*np.abs(x4)
	ham[0][1] = 0.
	ham[0][2] = 0.
	ham[0][3] = 0.
	...
	ham[0][8] = 0.
	ham[1][0] = 0.
	ham[1][1] = -3.438419298562535*x0 + 1.1965860528261985*x0*x1 - 4.224056976729521*x0*x3 + 3.438419298562535*x0*np.abs(x1) + 3.438419298562535*x0*np.abs(x2) + 3.438419298562535*x0*np.abs(x3) + 3.438419298562535*x0*np.abs(x4)
	ham[1][2] = 0.
	ham[1][3] = 0.
	ham[1][4] = 0.
	...
	ham[2][0] = 0.
	ham[2][1] = 0.
	ham[2][2] = 4.449719092257398*x0 - 1.3675269175156552*x0*x1 - 2.2126012735249874*x0*x3 - 4.449719092257398*x0*np.abs(x1) - 4.449719092257398*x0*np.abs(x2) - 4.449719092257398*x0*np.abs(x3) - 4.449719092257398*x0*np.abs(x4)
	ham[2][3] = 0.
	ham[2][4] = 0.
	ham[2][5] = 0.
	...
	ham[3][1] = 0.
	ham[3][2] = 0.
	ham[3][3] = 0.20225995873897262*x0 - 2.9059946997207677*x0*x1 + 1.8103101328840805*x0*x3 - 0.20225995873897262*x0*np.abs(x1) - 0.20225995873897262*x0*np.abs(x2) - 0.20225995873897262*x0*np.abs(x3) - 0.20225995873897262*x0*np.abs(x4)
	ham[3][4] = 0.
	ham[3][5] = 0.
	ham[3][6] = 0.
	...
	ham[4][2] = 0.
	ham[4][3] = 0.
	ham[4][4] = -4.0451991747794525*x0 - 3.4188172937891386*x0*x1 + 3.620620265768161*x0*x3 + 4.0451991747794525*x0*np.abs(x1) + 4.0451991747794525*x0*np.abs(x2) + 4.0451991747794525*x0*np.abs(x3) + 4.0451991747794525*x0*np.abs(x4)
	ham[4][5] = 0.
	ham[4][6] = 0.
	ham[4][7] = 0.
	...
	ham[5][3] = 0.
	ham[5][4] = 0.
	ham[5][5] = 0.20225995873897262*x0 - 2.9059946997207677*x0*x1 + 1.8103101328840805*x0*x3 - 0.20225995873897262*x0*np.abs(x1) - 0.20225995873897262*x0*np.abs(x2) - 0.20225995873897262*x0*np.abs(x3) - 0.20225995873897262*x0*np.abs(x4)
	ham[5][6] = 0.
	ham[5][7] = 0.
	ham[5][8] = 0.
	ham[6][0] = 0.
	...
	ham[6][4] = 0.
	ham[6][5] = 0.
	ham[6][6] = 4.449719092257398*x0 - 1.3675269175156552*x0*x1 - 2.2126012735249874*x0*x3 - 4.449719092257398*x0*np.abs(x1) - 4.449719092257398*x0*np.abs(x2) - 4.449719092257398*x0*np.abs(x3) - 4.449719092257398*x0*np.abs(x4)
	ham[6][7] = 0.
	ham[6][8] = 0.
	ham[7][0] = 0.
	ham[7][1] = 0.
	...
	ham[7][5] = 0.
	ham[7][6] = 0.
	ham[7][7] = -3.438419298562535*x0 + 1.1965860528261985*x0*x1 - 4.224056976729521*x0*x3 + 3.438419298562535*x0*np.abs(x1) + 3.438419298562535*x0*np.abs(x2) + 3.438419298562535*x0*np.abs(x3) + 3.438419298562535*x0*np.abs(x4)
	ham[7][8] = 0.
	ham[8][0] = 0.
	ham[8][1] = 0.
	ham[8][2] = 0.
	...
	ham[8][6] = 0.
	ham[8][7] = 0.
	ham[8][8] = 0.8090398349558905*x0 + 4.786344211304794*x0*x1 + 2.8160379844863472*x0*x3 - 0.8090398349558905*x0*np.abs(x1) - 0.8090398349558905*x0*np.abs(x2) - 0.8090398349558905*x0*np.abs(x3) - 0.8090398349558905*x0*np.abs(x4)
	return ham
